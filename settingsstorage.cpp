...
void SettingsStorage::readXml()
{
    ...
    font.clear();
    font_size.clear();
    line_wrap_mode.clear();
    line_numeration.clear();
    lang.clear();
    background_color.clear();
    controlflow_color.clear();
    keywords_color.clear();
    types_color.clear();
    preprocessor_color.clear();
    normal_text_color.clear();
    comments_color.clear();
    functions_color.clear();
    search_background_color.clear();
